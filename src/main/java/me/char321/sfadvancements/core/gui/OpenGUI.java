...
public class OpenGUI {
    ...
    private void refreshArrows() {
        ...
        if (page == maxPage) {
            rightArrow = new CustomItemStack(Material.BLACK_STAINED_GLASS_PANE, "&7Página siguiente", pageLore);
        } else {
            rightArrow = new CustomItemStack(Material.LIME_STAINED_GLASS_PANE, "&ePágina siguiente", pageLore);
        }
